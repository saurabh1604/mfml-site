...
const EXPECT_CHECKS = { 1: 11, 2: 11, 3: 13, 4: 13, 5: 17, 6: 17, 7: 16, 8: 17, 9: 13 };
...
(async () => {
  ...
  console.log('\n— index (hub) —');
  {
    ...
    const want = ['13 widgets · 11 checks · 10 problems', '6 widgets · 11 checks · 18 problems',
                  ...
                  '7 widgets · 16 checks · 11 problems', '9 widgets · 17 checks · 12 problems', '9 widgets · 13 checks · 12 problems'];
    ...
    if (overall !== '15 of 128 checks passed') fail('hub', `overall reads "${overall}", expected "15 of 128 checks passed"`);
    const barW = await page.evaluate(() => document.getElementById('obar-fill').style.width);
    if (barW !== '11.7%') fail('hub', `overall bar width ${barW}, expected 11.7%`);
